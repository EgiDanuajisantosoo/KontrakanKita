            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-600 mt-2">
                        ...
                        <span><strong>Jumlah Anggota:</strong> {{ $group->users->count() }} /
                ...
                <form method="POST" action="/forums/{{ $group->id }}/messages" class="flex items-center gap-2">
                    ...
                    <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 shadow hover:cursor-pointer">
                        Kirim
                    </button>
                </form>
            </div>
        ...
        <div class="container mx-auto p-5">
            <div class="cardColumn ">
                <div class=" mb-4 bg-[#003A9D] text-white w-auto sm:w-sm rounded-lg flex">
                    ...
                    <select name="" id="radius" class="bg-[#003A9D]" onchange="updateRadius()" value="10">
...
<script src="https://cdn.jsdelivr.net/npm/laravel-echo/dist/echo.iife.js"></script> --}}
        <script src="{{ asset('build/assets/app-6u8c6XXg.js ') }}"></script>
        <script>
