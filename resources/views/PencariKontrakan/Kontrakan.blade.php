    ...
    <x-slot:content>
        <div class="content bg-gray-100">
            ...
            <div class="container mx-auto p-5">
                <div class="cardColumn ">
                    ...
                    <div id="loading" class="text-center text-gray-500 my-4 sm:text-left lg:text-left">Loading rekomendasi...</div>
                    <div id="data" class="text-center text-gray-500 my-4 sm:text-left lg:text-left hidden">Tidak ada Kontrakan dalam Jangkuan 10km</div>
        ...
        <script>
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                // document.getElementById('test').innerHTML = "Latitude: " + latitude + "<br>Longitude: " + longitude;
                fetch('/rekomendasi-lokasi?latitude=' + latitude + '&longitude=' + longitude)
                                    ...
                                    <div class="text p-3 md:p-5">
                                        ...
                                        <div class="flex gap-3 mt-3">
                                            ...
                                            <div class="flex gap-1">
                                                ...
                                                <p class="text-[10px] md:text-xs">${kontrakan.kamar_tidur} kamar mandi</p>
                                            </div>
