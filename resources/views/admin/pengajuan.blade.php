                ...
                <table class="min-w-full divide-y divide-gray-200 bg-white rounded-lg">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase">Nama Kontrakan
                            </th>
                            ...
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase">Tipe Properti
                            </th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach ($kontrakan as $no => $data)
                            <tr>
                                ...
                                <td class="px-4 py-2">{{ $data->provinsi }},{{ $data->kota }},{{ $data->kecamatan }}
                                </td>
                                <td class="px-4 py-2">
